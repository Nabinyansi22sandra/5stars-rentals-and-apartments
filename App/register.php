...
<?php include '../include/header.php';?>
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#212529;" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../index.php"><img src="Logo.png" width="80px"alt="logo"></a>
...
<section class="wrapper" style="margin-left: 16%;margin-top: -11%;">
	...
	<ul class="nav nav-tabs" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Rentals</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Apartments</a>
	  </li>
	</ul>
