<!-- <div class="row"> -->			
  <div class="col-md-11 col-xs-12 col-sm-12">
  	<div class="alert alert-info" role="alert">
		...
		?>
  		<h2 class="text-center">Register Rentals</h2>
  		<form action="" method="post" enctype="multipart/form-data">
		  	 <div class="row">
				...
				<div class="col-md-4">
				  <div class="form-group">
				    <label for="alternat_mobile">Second Mobile</label>
			...
			<div class="row">
			 ...
			 <div class="form-group">
			  ...
			  <button type="submit" class="btn btn-primary" name='register_rentals' value="register_rentals">Register</button>
			</form>	
			</div>			
  	</div>
<!-- </div> -->