					...
					<div class="row">						
						...
						<?php 
							if($_SESSION['role'] == 'admin'){ 
								...
								echo '<b>Rentals $ Apartments: <span class="badge badge-pill badge-success">'.(intval($total_rent['total_rent'])+intval($total_rent_apartment['total_rent_apartment'])).'</span></b>';
								echo '</div></a>';
								echo '</div>';
							} 
						?>
